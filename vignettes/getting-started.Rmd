...
These defaults are informed by recommendations from the Stan User's Guide (Stan Development Team, 2024), Luo and Jiao (2018), and the edstan package (Furr, 2017).
